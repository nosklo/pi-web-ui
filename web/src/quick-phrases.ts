/**
 * 快捷短语内置默认值（按界面语言 "zh" | "en" | "it" | "pt"，与 i18n Locale 对齐）。
 *
 ...
 */
export const QUICK_PHRASE_DEFAULTS: Record<"zh" | "en" | "it" | "pt", string[]> = {
	...
	pt: ["Continuar", "Resumir", "Explique em detalhes", "Verifique e corrija os problemas", "Adicione cobertura de testes", "Publique a release"],
};
